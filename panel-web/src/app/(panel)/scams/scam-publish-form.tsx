...
export function ScamPublishForm({ channels }: { channels: Channel[] }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setSending(true);
    setError('');
    const res = await fetch('/api/scammers/publish', {
      method: 'POST',
  ...
  return (
    <form onSubmit={submit}>
      <div>
        <label>Salon où afficher l'embed des scammeurs</label>
